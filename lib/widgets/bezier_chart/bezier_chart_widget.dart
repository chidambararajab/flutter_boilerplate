...
class BezierChartState extends State<BezierChart>
  ...
  // TODO(weilu): Amendments horizontalPadding = 50.0;
...
//        if (!kIsWeb) { // TODO(weilu): web already supported
        canvas.drawPoints(
            PointMode.points,
            dataPoints,
            paintControlPoints
...
//        }
    ...
    if (verticalIndicatorPosition != null && showIndicator) {
      ...
      // TODO(weilu): Amendments infoHeight / (8.75)
